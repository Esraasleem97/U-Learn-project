@extends('teacherstage::layouts.master')
@section('content')
<div class=" ">
    <form action="">
        @csrf
        <div class="container mx-auto ">
            ...
            <div class="border shadow-xl rounded-md w-full bg-white py-36 px-12">
                ...
                <div class="flex justify-center items-center mt-10">
                    <input type="submit" value="المتابعة" class="py-2 px-4 border border-blue-800 transition duration-300 bg-blue-800 text-white hover:text-blue-800 hover:bg-transparent">
                </div>
            </div>
        </div>
    </form>
